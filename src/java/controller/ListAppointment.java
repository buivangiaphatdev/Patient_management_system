 ...
 * @author PC
 */
@WebServlet(name = "ListAppointment", urlPatterns = {"/ListAppointment"})
public class ListAppointment extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
     ...
     Patient app=(Patient)request.getSession().getAttribute("PATIENT");
     request.setAttribute("apps",new AppointmentDAO().getAppointment(app.getPatientID()));
