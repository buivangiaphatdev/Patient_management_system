                    ...
                    <div class="panel panel-default contentinside">
                        ...
                        <div class="panel panel-default contentinside">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" action="adminupdatepatient" method="POST">
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" name="doctor">
                                              <!--  <c:forEach items="${DoctorDAO.listAllDoctor()}" var="doc">
                                                ...
                                                <option>Nguyen Tuyet Nhi</option>
                                                <option>Nguyen Luong Trung</option>
                                                <option>Bui Hoang Y</option>
                                                <option>Bui Tuan Dung</option>
                                                <option>Dinh Van Toan</option>
                                                <option>Dinh Thi Cat Tuong</option>
                                                <option>Dinh Sy Quoc Viet</option>
                                                <option>Dinh Nguyen Bao Hung</option>
